report 50263 "Order Confirmation Report"
{
    ApplicationArea = All;
    Caption = 'Order Confirmation Report';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = 'Order Confirmation Report.rdl';
    ...
    dataset
    {
        dataitem(SalesCommentLine; "Sales Comment Line")
        {
            ...
            column(RateOfIntrest; RateOfIntrest)
            {
            }
            ...
            //pra
            column(UnitOfMeasure; SalesLine."Unit of Measure Code")
            {
            }
    ...
    begin
        ...
        RateOfIntrest:=glsetup."Rate of Interest";
        LCYcode:=glsetup."LCY Code";
    end;
    var //pra
    ccvalue: decimal;
    glsetup: record "General Ledger Setup";
    RateOfIntrest: Decimal;
    LCYcode: Code[40];
    //pra
