report 50255 "Inventory Repoort with name"
{
    DefaultLayout = RDLC;
        ...
        dataitem(Item; Item)
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("Item Ledger Entry"; "Item Ledger Entry")
                {
                    ...
                    RequestFilterFields = "Entry Type", "Document No.", Description, "Entry No.", Quantity, "Posting Date", "Location Code", "Global Dimension 1 Code", "Global Dimension 2 Code";
                    ...
                    begin
                        ...
                        Clear(IncreasesQty);
                        Clear(DecreasesQty);
                        if Quantity > 0 then IncreasesQty:=Quantity
                        else
            ...
            begin
                ...
                if PrintOnlyOnePerPage then RecordNo:=RecordNo + 1;
            end;
            trigger OnPreDataItem()
            begin
                RecordNo:=1;
