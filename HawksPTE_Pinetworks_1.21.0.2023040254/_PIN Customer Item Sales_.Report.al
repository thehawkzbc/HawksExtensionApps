report 50156 "PIN Customer Item Sales"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerItemSales.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Customer/Item Sales (modified)';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Value Entry"; "Value Entry")
            {
                ...
                begin
                    ...
                    if EntryInBufferExists then ValueEntryBuffer.Modify()
                    else
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    if Number = 1 then ValueEntryBuffer.Find('-')
                    else
