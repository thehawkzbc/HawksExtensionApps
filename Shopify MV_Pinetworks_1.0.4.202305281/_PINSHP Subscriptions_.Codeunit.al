codeunit 50890 "PINSHP Subscriptions"
{
    ...
    begin
        ShpfyOrderLine.SetRange("Shopify Order Id", OrderHeader."Shopify Order Id");
        ShpfyOrderLine.CalcSums("Discount Amount");
        if ShpfyOrderLine.IsEmpty()then SalesCalcDiscountByType.ApplyInvDiscBasedOnAmt(OrderHeader."Discount Amount", SalesHeader);
