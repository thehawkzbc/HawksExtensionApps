report 50079 "Hawks Std Sales - Invoice"
{
    RDLCLayout = './HawksSalesInvoice.rdl';
    WordLayout = './HawksSalesInvoice.docx';
    Caption = 'Hawks Sales - Invoice';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(HeaderPicture; CompanyInfo.ReportPicture)
            {
            }
    ...
    trigger OnPreReport()
    begin
        ccvalue:=GLSetup."USD Conversion Factor";
    ...
    LCYTxt: label ' (LCY)';
    VATClauseText: Text;
    protected var CompanyBankAccount: Record "Bank Account";
    ...
    begin
        ...
        if SalesInvoiceLine."Allow Invoice Disc." then VATAmountLine2."Inv. Disc. Base Amount":=SalesInvoiceLine."Line Amount";
